...
* Create a terraform.tfvars file to enter your vSphere environment details and virtual machine settings. An example has been included below for convenience.
